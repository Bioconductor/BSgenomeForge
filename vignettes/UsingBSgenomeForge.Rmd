...
1. Information about the assembly ASM836960v1 can be found at https://www.ncbi.nlm.nih.gov/assembly/GCA_008369605.1/, including the assembly
accession, *GCA_008369605.1* and organism name, *Vibrio cholerae*.
Assembly ASM836960v1 contains three circular sequence, "MT" which must
...
2. Information about the assembly ASM972954v1 can be found at https://www.ncbi.nlm.nih.gov/assembly/GCF_009729545.1/, including the assembly
...
These operations can also be carried out within R, instead, using the `devtools`
package
...
```{r}
devtools::check("./BSgenome.Ainfernus.NCBI.ASM972954v1")
```
