...
`r Biocpkg("BSgenome")` data packages are one of the many types of annotation
packages available in [*Bioconductor*](https://bioconductor.org). They contain
the genomic sequences, which comprise chromosome sequences and other DNA
...
contains the genomic sequences of the hg19 genome from [UCSC](https://genome.ucsc.edu/cgi-bin/hgGateway). Users can easily
...
1.Information about the assembly ASM972954v1 can be found at https://www.ncbi.nlm.nih.gov/assembly/GCF_009729545.1/, including the assembly
...
2.Information about the assembly ASM836960v1 can be found at https://www.ncbi.nlm.nih.gov/assembly/GCA_008369605.1/, including the assembly
...
See CP043554.1, CP043556.1, and CP043555.1 in the NCBI Nucleotide database at https://www.ncbi.nlm.nih.gov/nuccore/. They must be specified as shown in the
example below;
